...
function Comida() {
   ...
   console.log(prrecio_total)
    ...
    const onSubmitHandler = (e) => {
        ...
        axios.post('https://111191617958.ngrok.io/api/v1/users', body)
            .then((result) => {
...
{/* <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="https://i.postimg.cc/W4m21TN9/body.png" class="d-block w-100" alt="..."/>
    </div>
...
{/* <div className="form-group row d-flex bd-highlight mb-1 d-flex flex-nowrap" id="tacos" >
<button type="button" className="btn btn-secondary"  id="btn-complemento"  onChange={onChangeInput} value={Salsa} value="true">Salsa</button>
...
<div>
    <label className="p-2 bd-highlight order-3 p-2">Mesa:</label>
    <input type="number"  id="input-ordenar" className="form-control" id="Mesa" onChange={onChangeInput} value= {Mesa}/>
</div>
